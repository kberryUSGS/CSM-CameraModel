...
{
  json isd
      = { { "reference_height", { { "minheight", -1 }, { "unit", "km" } } } };
...
{
  json isd
      = { { "reference_height", { { "maxheight", 10 }, { "unit", "km" } } } };
...
TEST (ISDParsing, TransverseDistortion)
{
  ...
  std::vector<double> coefficients
      = { -1, 2, 4, 0, 0, 0, 0, 0, 0, 0, -11, 21, 24, 0, 0, 0, 0, 0, 0, 0 };
