...
TEST_F(ConstVelocityLineScanSensorModel, ProximateImageLocus)
{
    ...
    EXPECT_NEAR(locusToGroundX * locus.direction.x + locusToGroundY * locus.direction.y + locusToGroundZ * locus.direction.z,
        0.0, 1e-10);
}
...
TEST_F(OrbitalLineScanSensorModel, ImageToGroundHeight)
{
    ...
    double height = sqrt(groundPt.x * groundPt.x + groundPt.y * groundPt.y + groundPt.z * groundPt.z);
