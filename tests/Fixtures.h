...
protected:
  ...
  void SetUp() override
  {
    ...
    auto logger =
      std::make_shared<spdlog::logger>(std::to_string(sensorId), ostream_sink);
...
protected:
                                                            ...
                                                            double newValue)
  {
    ...
    csm::Model* model =
      cameraPlugin.constructModelFromISD(isd, "USGS_ASTRO_FRAME_SENSOR_MODEL");
...
protected:
  ...
  void SetUp() override
  {
    ...
    csm::Model* model =
      sarCameraPlugin.constructModelFromISD(isd, "USGS_ASTRO_SAR_SENSOR_MODEL");
