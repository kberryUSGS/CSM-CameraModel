...
std::string
UsgsAstroPlugin::getPluginName () const
{
...
std::string
UsgsAstroPlugin::getManufacturer () const
{
...
std::string
UsgsAstroPlugin::getReleaseDate () const
{
...
csm::Version
UsgsAstroPlugin::getCsmVersion () const
{
...
size_t
UsgsAstroPlugin::getNumModels () const
{
...
std::string
UsgsAstroPlugin::getModelName (size_t modelIndex) const
{
...
std::string
UsgsAstroPlugin::getModelFamily (size_t modelIndex) const
{
...
// This function takes a csm::Isd which only has the image filename set. It
// uses this filename to find a metadata json file located alongside the image
// file and returns a json encoded string.
std::string
...
std::string
UsgsAstroPlugin::getStateFromISD (csm::Isd imageSupportData) const
{
...
csm::Model *
UsgsAstroPlugin::constructModelFromISD (
...
UsgsAstroPlugin::constructModelFromState (const std::string &modelState,
                                          csm::WarningList *warnings) const
{
  MESSAGE_LOG ("Runing constructModelFromState with modelState: {}",
               modelState);
