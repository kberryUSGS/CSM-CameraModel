...
UsgsAstroPlugin::getModelName(size_t modelIndex) const
{
  ...
  MESSAGE_LOG("Get Model Name: {}. Used index: {}",
              supportedModelNames[modelIndex],
              modelIndex);
...
bool
UsgsAstroPlugin::canModelBeConstructedFromISD(const csm::Isd& imageSupportData,
                                              const std::string& modelName,
                                              csm::WarningList* warnings) const
{
  try {
                                            ...
                                            csm::WarningList* warnings) const
{
  ...
  MESSAGE_LOG(
    "Get model name from model state. State: {}, Name: {}", modelState, name);
  if (name == "") {
...
bool
UsgsAstroPlugin::canISDBeConvertedToModelState(const csm::Isd& imageSupportData,
                                               const std::string& modelName,
                                               csm::WarningList* warnings) const
{
