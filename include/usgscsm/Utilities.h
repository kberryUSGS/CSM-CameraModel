...
void computePixel (const double &distortedX, const double &distortedY,
                   ...
                   const double iTransS[], const double iTransL[],
...
void createCameraLookVector (const double &undistortedFocalPlaneX,
                             ...
                             const double &focalLength, double cameraLook[]);
...
// Arguments are two inputs that bracket a root, the function, and a
...
double computeEllipsoidElevation (double x, double y, double z,
