...
class UsgsAstroLsSensorModel : public csm::RasterGM,
 ...
 private:
  ...
  void reconstructSensorDistortion(double& focalX,
                                   double& focalY,
  ...
  void lightAberrationCorr(const double& vx,
                           const double& vy,
                           const double& vz,
                           const double& xl,
                           const double& yl,
  ...
  void losEllipsoidIntersect(const double& height,
                             const double& xc,
                             const double& yc,
                             const double& zc,
                             const double& xl,
  ...
  void getAdjSensorPosVel(const double& time,
                          const std::vector<double>& adj,
                          double& xc,
                          double& yc,
                          double& zc,
